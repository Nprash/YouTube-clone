  ...
  return (
    <div className='grid grid-flow-col relative  box-border'>
      ...
      {/* Conditionally render the Sidebar based on isSidebarVisible */}
      {
        isMenuOpen ? (
          <>
          <div className={`col-span-1 w-fit box-border z-50  sm:col-span-3 md:col-span-4  lg:col-span-3 xl:col-span-2`}>
            <Sidebar/>
          </div>
      ...
      <div className={`relative  mx-auto px-auto ${!isMenuOpen? "col-span-11 -left-32 w-full items-center": "col-span-11 -left-6  "} ${isLocation.pathname.includes('/watch')? "col-span-10 items-center xl:left-32 sm:left-48 md:-left-[50px]  box-border ":" border-box"}  sm:col-span-9 md:col-span-8 md:mx-auto md:px-auto lg:col-span-9 xl:col-span-10  box-border `}>
        <Outlet />
      </div> 
