  ...
  return (
    ...
    <div className='grid grid-flow-col bg-gray-50 p-2 fixed w-full z-10'>
        ...
        <div className='col-span-10 '>
            ...
            <span className='text-xl border bg-gray-100 rounded-full w-10 flex justify-center items-center'><IoMdMic/></span>
            </div>
            </div>
            {/* <div className='w-[30rem] absolute flow-c 0enter bg-white py-2 px-3'>
                <ul>
                     <li>iphone</li> 
